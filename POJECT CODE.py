...
conn=sql.connect(host='localhost',user='root',passwd='abhi9650',
database='bank')
if conn.is_connected():
 print('connected succesfully')
 cur = conn.cursor()
 cur.execute('''create table customer_detail
          (acct_no int primary key,acct_name varchar(25)
         ,phone_no int(25) check(phone_no>11),address
     ...
     if cur.fetchone() is  None:
          ...
          while c == 'y':
                         ...
                         if n == 2:
                              ...
                              count=cur.rowcount
                              conn.commit()
                              cur.execute('create table transactions(acc_no varchar(25),dt date,amt varchar(25),cr_amt varchar(25) )')
                              if count == 0:
                                   print()
                         ...
                         if n == 4:
                               ...
                               if cur.fetchone() is  None:
                                   ...
                                   cur.execute('select * from transactions where acc_no='+str(acct_no) )
                                   data=cur.fetchall()
                                   for row in data:
                                        print('ACCOUNT NO=',acct_no)
                                        print()
